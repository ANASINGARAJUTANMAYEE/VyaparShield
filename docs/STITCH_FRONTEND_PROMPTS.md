# CyberSure MSME — Stitch frontend prompts

## Shared design system

```text
Design a modern responsive SaaS web app called “CyberSure MSME”, an affordable cybersecurity health-check platform for Indian small businesses.
...
Brand: small teal shield/diamond mark, “CyberSure” in bold and “MSME” as a small teal label. Navigation items: Dashboard, Targets, Reports. On the right: language selector, profile avatar.
...
```text
Create a polished SaaS landing page for CyberSure MSME.

Hero heading: “Know what is exposed. Fix what matters first.”
Subheading: “CyberSure turns confusing website security risks into a verified, prioritised action plan for small businesses.”
...
```text
Design the CyberSure MSME onboarding screen, step 1 of 3.
...
Add: “Your answers help prioritise findings. CyberSure does not sell business data.” Primary button: “Continue to website verification”. Show a small right-side illustration of a small business storefront connected to a secure shield.
```

## Screen 3 — Website verification

```text
Design the CyberSure MSME target verification screen, step 2 of 3.
...
After generation, show a highlighted token card: DNS TXT value or file content; cybersure-verify=8af32d91ce4b. Add tabs for “DNS TXT record” and “Verification file”; file location: https://store.kiranakart.in/.well-known/cybersure-verification.txt. Include “I have added the token” and a green success state: “store.kiranakart.in verified”.

Add a security note: “CyberSure blocks private networks, localhost, unverified domains, password attacks, and intrusive testing.” Use clear visual instructions rather than technical clutter.
```

## Screen 4 — Consent and scan scope

```text
Design the CyberSure MSME consent screen, step 3 of 3.
...
```text
Design a scan progress screen for CyberSure MSME.
...
Include safety notice: “CyberSure is not attempting exploitation or accessing any private data.” Add “What happens next?”: “Your results will be translated into business-friendly actions and technical developer guidance.” Keep this screen uncluttered and reassuring.
```

## Screen 6 — Security dashboard

```text
Design the main CyberSure MSME security dashboard after a scan.
...
```text
Design a detailed finding page for CyberSure MSME in the business owner view.
...
```text
Design the developer view for the same CyberSure MSME finding.
...
```text
Design a CyberSure MSME re-scan comparison page.
...
```text
Design a CyberSure MSME report export page.
